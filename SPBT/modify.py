...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Message1.place(relx=0.367, rely=0.045,
                            relheight=0.052, relwidth=0.237)
        ...
        self.Message2.place(relx=0.71, rely=0.045,
                            relheight=0.052, relwidth=0.189)
        ...
        self.Button1.configure(command=self.getForm)
        self.Button1_42.configure(command=self.goBack)
        self.Button1_43.configure(command=self.modifyRecord)
    ...
    def getForm(self):
        ...
        if var1 == '' :
            ...
            self.Message2.configure(text='''ID Empty''')
            ...
            if ser[:2] == "NO":
                self.Message2.configure(background=color)
                self.Message2.configure(text='''NOT FOUND''')
                self.Entry2.delete(0, tk.END)
                self.Entry3.delete(0, tk.END)
                self.Entry4.delete(0, tk.END)
                self.Entry5.delete(0, tk.END)
                ...
                self.Entry20.delete(0, tk.END)
                ser_li = ser.split("|")
                self.Entry2.insert(0, ser_li[1])
                self.Entry3.insert(0, ser_li[2])
                self.Entry4.insert(0, ser_li[3])
                self.Entry5.insert(0, ser_li[4])
                self.Entry6.insert(0, ser_li[5])
                self.Entry7.insert(0, ser_li[6])
                self.Entry8.insert(0, ser_li[7])
                self.Entry9.insert(0, ser_li[8])
                self.Entry10.insert(0, ser_li[9])
                self.Entry11.insert(0, ser_li[10])
                self.Entry12.insert(0, ser_li[11])
                self.Entry13.insert(0, ser_li[12])
                self.Entry14.insert(0, ser_li[13])
                self.Entry15.insert(0, ser_li[14])
                self.Entry16.insert(0, ser_li[15])
                self.Entry17.insert(0, ser_li[16])
                self.Entry18.insert(0, ser_li[17])
                self.Entry20.insert(0, ser_li[18])
    ...
    def modifyRecord(self):
        ...
        if var1 == '' or var2 == '' or var3 == '' or var4 == '' or var5 == '' or var6 == '' or var7 == '' or var8 == '' or var9 == '' or var10 == '' or var11 == '' or var12 == '' or var13 == '' or var14 == '' or var15 == '' or var16 == '' or var17 == '' or var18 == '' or var19 == '':
            self.Message2.configure(background=color)
            self.Message2.configure(text='''Boxes Empty''')
        else :
            var1 = str(self.Entry1.get())
            var2 = str(self.Entry2.get())
            var3 = str(self.Entry3.get())
